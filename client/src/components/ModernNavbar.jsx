...
const ModernNavbar = () => {
  ...
  const siteContent = [
    {
      title: "BrahMos Batch 2 - Flagship Program",
      category: "Course",
      path: "/courses",
      icon: <Book size={18} className="text-primary" />,
      keywords: "brahmos batch ssc cgl chsl mts maths english gs flagship",
    },
    {
      title: "GS 1.0 - General Studies",
      category: "Course",
      path: "/courses",
      icon: <Book size={18} className="text-primary" />,
      keywords: "gs general studies science gk static",
    },
    {
      ...
      path: "/courses",
      icon: <Book size={18} className="text-primary" />,
      keywords: "english vocabulary rc cloze test para jumbles",
    },
    {
      ...
      path: "/courses",
      icon: <Book size={18} className="text-primary" />,
      keywords: "wpme word power made easy vocabulary visual",
    },
    {
      title: "SSC 2025 Previous Papers",
      category: "Quiz",
      path: "/quizzes",
      icon: <HelpCircle size={18} className="text-purple-600" />,
      keywords: "ssc previous papers pyq 2025 practice",
    },
    {
      ...
      path: "/quizzes",
      icon: <HelpCircle size={18} className="text-purple-600" />,
      keywords: "current affairs daily ca quiz gk",
    },
    {
      title: "Vocabulary - Word Drop",
      category: "Quiz",
      path: "/quizzes",
      icon: <HelpCircle size={18} className="text-purple-600" />,
      keywords: "vocabulary word drop synonyms antonyms",
    },
    {
      title: "Leaderboards",
      category: "Feature",
      ...
      keywords: "leaderboard rankings top performers brahmos batch",
    },
    {
      ...
      keywords: "blog articles notes stories coming soon",
    },
    {
      ...
      keywords: "contact support whatsapp telegram email call",
    },
    {
      title: "FAQs",
      category: "Page",
      ...
      keywords: "faq questions help refund mentorship installment",
    },
    {
      ...
      keywords: "courses catalog browse all enroll",
    },
  ];
    ...
    >
      <div className="flex-row">
        <div className="container-custom">
          ...
          <div
            className={`relative bg-white/70 backdrop-blur-2xl rounded-3xl border border-white/30 shadow-2xl transition-all duration-500 ${
              isScrolled
                ? "shadow-3xl bg-white/80 border-white/40"
                : "shadow-2xl"
